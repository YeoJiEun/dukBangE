...
public class ConnectionManager {
    ...
    private static final String DB_URL = "jdbc:oracle:thin:@202.20.119.117:orcl";
    private static final String DB_USERNAME = "dbp0206";
    private static final String DB_PASSWORD = "615615";
    */
